    ...
    try {
      ...
      await sendEmail(email, 'Welcome to Sentiom!', `
        <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:0 auto;background:#0F1110;color:#E8E8E6;padding:40px 32px;border-radius:12px">
          ...
          <p style="color:#9A9C99;line-height:1.7;margin-bottom:16px;font-style:italic;border-left:3px solid #1D9E75;padding-left:16px">De-automate your dollars. Somewhere between auto-pay bills and tap-to-pay lattes, we stopped looking at where our money actually goes. We let our financial habits slip into the background.<br><br>Welcome to Sentiom — the digital equivalent of a 90s pen-and-paper ledger. No bank syncing, no automatic categorization, and zero background noise. By forcing you to manually track every single dollar, we're bringing intentionality back to your wallet. It's time to take your money off autopilot.</p>
